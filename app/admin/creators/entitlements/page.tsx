...
export const metadata: Metadata = {
  title: "Creator entitlements · Admin",
};

export const dynamic = "force-dynamic";

export default async function AdminCreatorEntitlementsPage({
  searchParams,
}: {
  ...
  return (
    <Container className="py-12 sm:py-16">
      ...
      <SectionHeading
        ...
        description="Monetization qualification for HUMAN/AI opt-in creators. Tracked CREATOR competitors (public rankings) are managed on the Creator rankings import page."
        action={
          <Link
            href="/admin/creators"
            className="text-sm font-medium text-accent-ink hover:underline"
          >
            Creator ranking imports
          </Link>
        }
      />
      ...
      <form
        action="/admin/creators/entitlements"
        method="get"
