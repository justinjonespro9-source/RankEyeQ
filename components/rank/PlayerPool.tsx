                ...
                trailing={
                  ranked ? (
                    ...
                    <button
                      ...
                      className="inline-flex min-h-10 items-center rounded-md bg-accent px-3 py-2 text-xs font-semibold text-ink hover:bg-accent-hover disabled:cursor-not-allowed disabled:opacity-50"
                    >
                      Add
                    </button>
                  )
